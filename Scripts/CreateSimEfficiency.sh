...
mu2eGenFilterEff --out=MDC2025_SimEff.txt --chunksize=100 sim.mu2e.MuBeamCat.MDC2025ab.art sim.mu2e.EleBeamCat.MDC2025ab.art sim.mu2e.NeutralsCat.MDC2025ab.art \
